...
| [`bridges/openclaw-host-bridge/`](bridges/openclaw-host-bridge/README.md) | OpenClaw / WeCom 宿主适配、runtime handoff、host diagnostics | milestone A skeleton |
| [`runtimes/navly-runtime/`](runtimes/navly-runtime/README.md) | thin runtime shell：interaction、routing、execution、answering、outcome | milestone A skeleton |
...
bash runtimes/navly-runtime/scripts/validate-milestone-a.sh
bash bridges/openclaw-host-bridge/scripts/validate-milestone-a.sh
